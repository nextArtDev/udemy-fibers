...
const Bike = (props) => {
  ...
  // We have to apply any changes after the first render, it means after the ue Effect or useFrame
  // useFrame and useRef runs after the first render, is it texture solution?
  useEffect(() => {
